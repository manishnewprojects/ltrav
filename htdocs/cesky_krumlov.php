      ...
      <div class="row">
        <div class="col-lg-9 col-sm-12 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="#">Castle, Dungeon, Village, River. Not a backlot.</a>
              </h4>
              <p class="card-text">Cesky Krumlov, Czechia
                ...
                <!-- WP TEXT BEGINS -->
                 ...
                 <b><i><u>TL;DR</u>: Must do day trip from Prague. Take the train.  Enjoy the castle museum. View from the tower is awesome. Pick up sandwiches from local grocery store in Cesky Krumlov. Avoid the touristy restaurants.</i></b>
                  ...
                  <img class="mv_image" src="images/cesky_krumlov/cesky_krumlov_train_station.jpg" alt="station cesky krumlov train"/>

                  For such a tourist destination, you would think that there would be lots of buses and taxis outside the station, but that wasn't the case at all. Which is just as well because its only about a 15 minute walk down to the castle. The walk takes you up and down a hill, along a a very picturesque path. As you are walking down the hill, you get a beautiful view of the castle and the village below. 

                  <img class="mv_image" src="images/cesky_krumlov/cesky_krumlov_view_from_station_road.jpg" alt="station cesky krumlov train"/>


                  A short walk later you find yourself looking up at this beautiful aqueduct leading up to the main castle. As you go under the aqueduct and over an idyllic bridge on the river, and you find yourself right in town, which in itself is almost frozen in the 14th century. 
                  ...
                  Looking out from top of the tower you see a river that flows over quant bridges and along a small town.  You could almost imagine looking down on people going about their daily business like they did hundreds of years agi.
                  The tower even has a real dungeon in the tower, which presumably held prisoners at one point.
                  You can spend couple of hours walking around the castle area, visiting the tower and the town next to it. Some parts of the town would clearly rebuilt, for the tourists. These parts look more like a Disneyland version. You can conveniently skip those and just focus on the real artifacts.  

                  <img class="mv_image" src="images/cesky_krumlov/cesky_krumlov_village_street.jpg" alt="village street cesky krumlov"/>

                  You can make your way back to the station for the 2:00 PM train back to Prague. We also picked up some groceries in town for sandwiches on the journey back. And the ride back is again smooth. You get to see the countryside all over again and will be back to Prague, at around a five in the evening leaving the evening free for other activities.   
